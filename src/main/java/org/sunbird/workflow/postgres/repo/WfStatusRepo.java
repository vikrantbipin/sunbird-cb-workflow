...
public interface WfStatusRepo extends JpaRepository<WfStatusEntity, String> {
    ...
    @Query(value = "select * from wingspan.wf_status where application_id IN ?1", nativeQuery = true)
    List<WfStatusEntity> findByApplicationIdIn(List<String> applicationIds);
