...
public interface WfStatusRepo extends JpaRepository<WfStatusEntity, String> {
    ...
    @Query(value = "select * from wingspan.wf_status where userid = ?1 and application_id = ?2", nativeQuery = true)
    List<WfStatusEntity> findByUserIdAndApplicationId(String userId, String applicationId);
