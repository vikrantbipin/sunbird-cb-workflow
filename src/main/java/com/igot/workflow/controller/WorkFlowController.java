...
public class WorkFlowController {
    ...
    public ResponseEntity<Response> getUserWF(@RequestHeader String rootOrg, @RequestHeader String org, @RequestHeader String wid, @RequestBody SearchCriteria searchCriteria) {
