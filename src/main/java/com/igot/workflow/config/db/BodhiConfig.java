...
package com.igot.workflow.config.db;
...
@EnableCassandraRepositories(basePackages = "com.igot.workflow.repository.cassandra.bodhi", cassandraTemplateRef = "bodhiTemplate")
